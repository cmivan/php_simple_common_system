...
CREATE TABLE `km_s_news` (
  ...
  `life_news` char(255) default NULL,
  `orderid` char(255) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=187 DEFAULT CHARSET=utf8;

CREATE TABLE `km_s_news_class_b` (
...
CREATE TABLE `km_s_news_class_s` (
...
CREATE TABLE `km_s_case_class_b` (
  `classid_b` bigint(10) NOT NULL auto_increment,
  `classname` char(50) default NULL,
  `classOrder` int(10) NOT NULL default '0',
  PRIMARY KEY  (`classid_b`)
...
CREATE TABLE `km_s_case_class_s` (
  `classid_s` bigint(10) NOT NULL auto_increment,
  `classid_b` bigint(10) default NULL,
  `classname` char(50) default NULL,
  `classOrder` int(10) NOT NULL default '0',
...
CREATE TABLE `km_product_class_b` (
  `classid_b` bigint(10) NOT NULL auto_increment,
  `classname` char(50) default NULL,
  `classOrder` int(10) NOT NULL default '0',
  PRIMARY KEY  (`classid_b`)
...
CREATE TABLE `km_product_class_s` (
  `classid_s` bigint(10) NOT NULL auto_increment,
  `classid_b` bigint(10) default NULL,
  `classname` char(50) default NULL,
  `classOrder` int(10) NOT NULL default '0',
